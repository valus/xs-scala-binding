...
trait CrossroadsIOLibrary extends Library {
  ...
  def xs_recv(socket: Pointer, buf: Array[Byte], len: Int, flags: Int): Int
  def xs_sendmsg(socket: Pointer, msg: xs_msg_t, flags: Int): Int
  def xs_send(socket: Pointer, buf: Array[Byte], len: Int, flags: Int): Int
  ...
  def xs_shutdown(socket: Pointer, how: Int): Int
  ...
  def xs_stopwatch_start(): Pointer
  def xs_stopwatch_stop(watch: Pointer): NativeLong
}
